...
function render(){
    ...
    model("bound-bunny_5k.smf");
        materialAmbient = vec3(0.9, 0.2, 0.3);
...
var secondaryLightPosition = vec3(0, 15, 5);
var secondaryLightAmbient = vec3(0.4, 0.2, 0.2);
var secondaryLightDiffuse  = vec3(0.0, 0.3, 0.5);
...
var vshader = "./gooch-vshader.glsl";
var fshader = "./gooch-fshader.glsl";
var xValue=0.0;
var yValue=0.0;
var lightXValue=0.0;
var lightYValue=0.0;
